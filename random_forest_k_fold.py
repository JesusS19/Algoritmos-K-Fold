# -*- coding: utf-8 -*-
"""
Created on Fri May 23 15:51:27 2025
...
# Import the RandomForestClassifier algorithm
...
# --- Flatten sequences for the RandomForestClassifier algorithm ---
# Traditional ML algorithms like RandomForestClassifier expect a 2D input (samples, flattened_features).
...
# These parameters are based on your RandomForest.py file.
# 'random_state' ensures reproducibility. 'n_jobs=-1' uses all CPU cores.
...
fold = 1
# Iterate through the folds using the flattened data for RandomForest
...
print(f"\n--- Overall Results for RandomForestClassifier ---")
...
plt.title(f"Overall Confusion Matrix - RandomForestClassifier (K-Fold Cross-Validation)")
plt.show()
